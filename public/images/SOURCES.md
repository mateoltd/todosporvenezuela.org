...
- `venezuela-earthquake-rescue.jpg`: used in the "Lo que está pasando" carousel. Credited in-page as AP Photo / Ariana Cubillos (same earthquake coverage) — PROVENANCE TO CONFIRM before publishing.
- `venezuela-earthquake-rubble.jpg`: used in the "Lo que está pasando" carousel. Credited in-page as AP Photo / Ariana Cubillos (same earthquake coverage) — PROVENANCE TO CONFIRM before publishing.
