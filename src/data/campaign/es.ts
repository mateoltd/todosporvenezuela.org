...
export const esContent: CampaignContent = {
  ...
  hero: {
    ...
    copy: "Jóvenes venezolanos llevan insumos médicos, alimentos e hidratación a las familias golpeadas por el terremoto, hasta en las comunidades más remotas.",
  ...
  devastation: {
    ...
    lede: "Estas son imágenes de prensa de los días posteriores al terremoto. Detrás de cada escombro hay comunidades enteras que hoy necesitan agua, medicinas y un lugar donde dormir.",
    facts: {
      magnitude: "Magnitud",
      depth: "Profundidad",
      date: "24 jun",
        ...
        photos: [
          {
            ...
            alt: "Voluntario con gorra roja empacando insumos",
          },
          {
            name: "02-black-shirt-packing",
            alt: "Voluntario con camisa negra empacando insumos",
          },
          {
            name: "03-black-cap-gift-table",
            alt: "Voluntario armando los kits en la mesa",
          },
          {
            name: "04-group-fridge-organizing",
            alt: "Equipo organizando los insumos recolectados",
          },
        ],
  ...
  notFound: {
    ...
    copy: "El enlace puede estar roto o la página se movió. Vuelve al inicio para seguir la campaña y ver cómo avanza la ayuda.",
    homeLink: "Volver al inicio",
  ...
  donationModal: {
    ...
    methods: {
      ...
      binance: {
        ...
        lead: "Envía tu aporte en {coin} por Binance Pay. Es una opción directa para donar desde Venezuela o desde el exterior.",
        fields: {
